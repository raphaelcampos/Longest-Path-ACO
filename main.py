...
if __name__ == "__main__":
	...
	#exit()
	colony = aco.AntColony(n_ants=args.n_ants, iterations=args.iterations, evaporation_rate=args.evaporation_rate, k=args.k_top, n_jobs=args.jobs, logger=aco.Logger(args.dump_folder + "/" + output, append=True), random_state=42)
